    ...
    <div>
      <div className="max-w-screen-lg mx-auto mt-4 lg-mt-5">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-2  py-4 px-6">
          <div className="md:col-span-4 p-10 text-white lg:mb-0 mb-[10px] bg-[#196039] rounded-[10px]">
            ...
            <p className="mt-4 leading-7 text-gray-200">
              Have questions? We're here to help! Contact us for plant advice, orders, or any assistance.
            </p>

            <div className="flex items-center mt-5">
              <svg className="h-6 mr-2 " fill="currentColor" version="1.1"
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
          ...
          <form className="md:col-span-8 px-2 lg:px-10" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full px-3">
                ...
                <textarea
                  className="appearance-none block w-full bg-gray-200 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white h-20 lg:h-32"
                  name="message"
